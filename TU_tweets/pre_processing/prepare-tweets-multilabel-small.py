...
if __name__ == '__main__':
    ...
    with open("../multilabel_data_small/data/unlabeled.jsonl", 'w+') as f:
        for tweet in unlabeled_tweets[:UNLABELED_SIZE]:
            f.write(json.dumps(tweet) + "\n")


    with open("../multilabel_data_small/data/train.jsonl", 'w+') as f:
        for tweet in labeled_tweets[:TRAIN_SIZE]:
            f.write(json.dumps(tweet) + "\n")

    with open("../multilabel_data_small/data/val.jsonl", 'w+') as f:
